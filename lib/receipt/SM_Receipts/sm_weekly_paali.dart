...
class SMWeeklyPaali extends StatefulWidget {
  const SMWeeklyPaali({Key? key}) : super(key: key);
  @override
  State<SMWeeklyPaali> createState() => _SMWeeklyPaaliState();
}

class _SMWeeklyPaaliState extends State<SMWeeklyPaali> {
