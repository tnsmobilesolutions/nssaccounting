...
class SammilaniMiscellaneous extends StatefulWidget {
  const SammilaniMiscellaneous({Key? key}) : super(key: key);
  @override
  State<SammilaniMiscellaneous> createState() => _SammilaniMiscellaneousState();
}

class _SammilaniMiscellaneousState extends State<SammilaniMiscellaneous> {
  DateTime? _dateTime;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text("Sammilani Miscellaneous"),
      ),
      body: Padding(
                  ...
                  onPressed: () {
                    if (_formKey.currentState!.validate()) {
                      Receipt receipt = Receipt(
                        accountCode: "Sammilani Miscellaneous",
